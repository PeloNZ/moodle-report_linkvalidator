...
add_to_log($course->id, "course", "report log", "report/linkvalidator/index.php?id=$course->id", $course->id);
...
if (!empty($chooselog)) {
    ...
    switch ($logformat) {
        case 'showashtml':
            ...
            report_linkvalidator_print_mnet_selector_form($hostid, $course, $user, $date, $modname, $modid, $modaction, $group, $showcourses, $showusers, $logformat);
    ...
    report_linkvalidator_print_selector_form($course, $user, $date, $modname, $modid, $modaction, $group, $showcourses, $showusers, $logformat);
}
